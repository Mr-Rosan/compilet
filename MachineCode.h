...
public:
    ...
    bool isBXInst() const { return type == BRANCH && op == 2; };
    bool isAddInst() const { return type == BINARY && op == 0; };
};
...
public:
    ...
    void output();
    void setCmpOp(int cond) { cmpOp = cond; };
    int getCmpOp() const { return cmpOp; };
};
...
public:
    ...
    int getAllocSpace() const { return this->stack_size;};
...
public:
    ...
    void output();
    int getGlobalNum() const { return globalNum; };
    void addGlobalNum() {globalNum++;};
};
